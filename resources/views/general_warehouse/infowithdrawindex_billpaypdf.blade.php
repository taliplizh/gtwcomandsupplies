...
<html>
    ...
    <label for=""> ชื่อหน่วยงาน &nbsp;&nbsp; 
        ...
        @if($inforwarehouserequests->HR_DEPARTMENT_SUB_SUB_NAME == '' || $inforwarehouserequests->HR_DEPARTMENT_SUB_SUB_NAME == null)
        {{$inforwarehouserequests->WAREHOUSE_SMALLHOS_NAME}}
        @else
        {{$inforwarehouserequests->HR_DEPARTMENT_SUB_SUB_NAME}}
        @endif
