  ...
  <div class="block-content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>อนุมัติการขอเบิกพัสดุ</B></h3>
            <br>
        </div>
        <br>
        <div class="block-content">
        <form  method="post" action="{{ route('mwarehouse.updatewarehouserequestlastapp') }}" enctype="multipart/form-data">
            ...
            <button type="submit" name = "SUBMIT"  class="btn btn-hero-sm btn-hero-success loadscreen" value="approved" ><i class="fas fa-clipboard-check mr-2"></i>อนุมัติ</button>
                ...
                <a href="{{url('manager_warehouse/disburse')}}" type="button"  class="btn btn-hero-sm btn-hero-secondary loadscreen" ><i class="fas fa-window-close mr-2"></i>ปิดหน้าต่าง</a>
