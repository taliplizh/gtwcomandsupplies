...
<div class="block mb-4" style="width: 95%;margin:auto">
    <div class="block-content">
        <div class="block-header block-header-default">
            <h3 class="block-title text-center fs-20">ตารางคลังหลัก :: วัสดุเหลือน้อย</h3>
        </div>
        <hr>
        <div class="block-content my-3 shadow table-responsive">
            <table id="datatable" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                @foreach($table_maxmin as $row)
                    <tr>
                        ...
                        <td class="text-center py-1 fs-13" style="">{{number_format($row->MIN)}}</td>
                        <td class="text-center py-1 fs-13" style="">{{number_format($row->net_amount-$row->MIN)}}</td>
